...
def generate_qr_code(data, label_w, label_h, format = "square"):
    ...
    if format == "square":
        ...
        draw.text(
            ((img_with_number.width - text_width) / 2, 20),
            text,
            fill='black',
            font=font
        )
        ...
        img_with_number.paste(img, (int((label_w * dpi - img.width) / 2), text_height+40))
        ...
        img_with_number.paste(img, (int(1*dpi-(1.05*img.width)),0))
